    ...
    try:
        ...
        cursor.execute("""
            ...
            WHERE estado = 'Autorizado' 
              AND moneda = %s
              AND MONTH(fecha_autorizacion) = %s
              AND YEAR(fecha_autorizacion) = %s
        """, (moneda, mes_actual, anio_actual))
...
def autorizar_autorizacion_y_solicitud(tree):
    ...
    try:
        ...
        cursor.execute("""
            ...
            SET estado = 'Autorizado', fecha_autorizacion = %s 
            WHERE id_autorizacion = %s
        """, (fecha_aut, id_autorizacion))
